        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-white/70 text-sm">Be among the first to book exclusive slowcation experiences</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">💰</span>
              </div>
              <h4 className="font-bold text-white mb-2">Special Pricing</h4>
              <p className="text-white/70 text-sm">Exclusive discounts and early bird pricing on all packages</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">📧</span>
              </div>
              <h4 className="font-bold text-white mb-2">VIP Updates</h4>
              <p className="text-white/70 text-sm">Get insider updates on new destinations and experiences</p>
            </div>
          </div>
        </div>
      </div>
